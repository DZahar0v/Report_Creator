...
contract PPContract is Ownable, EIP712Alien {
    ...
    constructor(ComptrollerInterface _comptroller, address _comp, address _limitOrderProtocol) 
        ...
        // FINDING: STATUS |WARNING| NAME |Unchecked addresses|
        // DESC |Addresses which passed to constructor do not checked:|
        // REC_TEXT |We recommend add following check:|
        // REC_CODE |require(address(_comptroller) != address(0) && _limitOrderProtocol != address(0) && _comp != address(0));|
